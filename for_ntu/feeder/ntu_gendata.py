...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/home/hhe/hhe_first_file/data_set/NTU-RGB-D-CV/original_data/nturgb+d_skeletons')
    parser.add_argument(
        '--ignored_sample_path',
        default='samples_with_missing_skeletons.txt')
    parser.add_argument('--out_folder', default='/home/hhe/hhe_first_file/data_set/NTU-RGB-D-CV')
