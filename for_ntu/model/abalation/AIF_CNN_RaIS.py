...
class AIF_CNN(nn.Module):
    ...
    def __init__(self,
        ...
        metric1_numpy =0.001 * np.eye(25).astype('float32') + np.random.randn(25).astype('float32')
        self.adat_metrices1 = nn.Parameter(torch.from_numpy(metric1_numpy))
        self.relu1 = nn.ReLU()
        ...
        metric_r1_numpy = 0.001 * np.eye(25).astype('float32') + np.random.randn(25).astype('float32')
        ...
        metric_r2_numpy =0.001 * np.eye(25).astype('float32') + np.random.randn(25).astype('float32')
        ...
        metric3_numpy =0.001 * np.eye(25, 26).astype('float32') + np.random.randn(25, 26).astype(
            'float32')
        ...
        metric4_numpy =0.001 * np.eye(13, 14).astype('float32') + np.random.randn(13, 14).astype(
            'float32')
        ...
        # motion
        metric1_numpy_m =0.001 * np.eye(25).astype('float32') + np.random.randn(25).astype('float32')
        ...
        metric_r1m_numpy =0.001 * np.eye(25).astype('float32') + np.random.randn(25).astype('float32')
        ...
        metric_r2m_numpy =0.001 * np.eye(25).astype('float32') + np.random.randn(25).astype('float32')
        ...
        metric3_numpy_m =0.001 * np.eye(25, 26).astype('float32') + np.random.randn(25, 26).astype(
            'float32')
        ...
        metric4_numpy_m =0.001 * np.eye(13, 14).astype('float32') + np.random.randn(13, 14).astype(
            'float32')
